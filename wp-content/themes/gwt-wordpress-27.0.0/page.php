					...
					<section class="contact-section py-5 py-lg-7 overflow-hidden">
						<div class="container-fluid px-4 px-lg-6">
							<div class="row g-0 shadow-lg rounded-4 overflow-hidden">
								...
								<div style="background-color: #008f13;" class="col-lg-6 bg-gradient-success text-white position-relative">
									<div class="p-5 p-xl-7 h-100 d-flex flex-column justify-content-center">
										<div class="mb-5">
											<h1 class="display-5 fw-bold mb-4 lh-1">Get in Touch</h1>
											<p class="lead opacity-90">We're here to help and answer any questions you might have.</p>
										</div>
												...
												<div class="d-flex align-items-start gap-4">
													...
													<div>
														...
														<p class="mb-0 opacity-90">
															<a href="mailto:labomayorsoffice@gmail.com" class="text-white text-decoration-none hover-opacity-75">
