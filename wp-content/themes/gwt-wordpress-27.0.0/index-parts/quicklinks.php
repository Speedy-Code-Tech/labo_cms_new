<div class="pt-5 container-fluid">
    ...
    <div class="row gap-4 d-flex flex-column flex-md-row  justify-content-center align-items-center">
        <div style="height: 200px;" class="t1 quick-links d-flex gap-4 justify-content-center align-items-center p-3 card col-12 col-md-3 bg-white shadow rounded">
            ...
            <h2 class="text-center" style="color:#03720D;">BPLO PAGE</h2>
        ...
        <div style="height: 200px;" class="t2 quick-links d-flex gap-4 justify-content-center align-items-center p-3 card col-12 col-md-3 bg-white shadow rounded">
            <img style="width:50px; height:50px;" src="<?= get_template_directory_uri() . '/images/bulb.png' ?>" />

            <h2 class="text-center" style="color:#03720D;">PROCUREMENT</h2>
        ...
        <div style="height: 200px;" class="t3 quick-links d-flex gap-4 justify-content-center align-items-center p-3 card col-12 col-md-3 bg-white shadow rounded">
            <img style="width:50px; height:50px;" src="<?= get_template_directory_uri() . '/images/building.png' ?>" />

            <h2 class="text-center" style="color:#03720D;">DEPARTMENT AND OFFICES</h2>
