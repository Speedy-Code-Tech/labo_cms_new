...
<div class="container-banner p-0 ">
    ...
    <div id="banner-slider" class="large-12 hide-for-small-only">
        ...
        <?php govph_displayoptions('govph_banner_title_start'); ?>
        <div class="large-9 columns container-main">
            <header class="search-hero position-relative overflow-hidden py-8 text-white text-center"
                style="background: url(<?= get_template_directory_uri() ?>/images/tourism/contact.png) center/cover no-repeat; height: 40vh; display: flex; align-items: center; justify-content: center;">
                <div class="position-absolute top-0 start-0 w-100 h-100" style="background: rgba(48, 48, 48, 0.7);">
                </div>
                <div class="position-relative z-10 container">
                    <h1 class="display-4 fw-bold poppins-regular">
                        Search Results
                    </h1>
                    <p class="fs-2 fw-light mt-3 poppins-regular">
                        “<?php echo esc_html(get_search_query()); ?>”
                    </p>
                    <hr class="border-white opacity-50 w-25 mx-auto">
                    <p class="fs-5 poppins-regular">Municipal Government of Labo • Camarines Norte</p>
                </div>
            </header>
        </div>
        <?php govph_displayoptions('govph_banner_title_end'); ?>
