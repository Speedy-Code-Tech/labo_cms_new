    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class('touristCard'); ?>
        ...
        <?php else : ?>
            <div class="bg-secondary bg-opacity-10 d-flex align-items-center justify-content-center h-100">
                <span class="text-muted fs-3 fw-bold poppins-regular">No Image</span>
            </div>
        <?php endif; ?>

        <!-- Green Overlay + Title on Hover (Center) -->
        <div class="overlay-center">
            <h3 class="title-hover poppins-regular"><?php the_title(); ?></h3>
        </div>

        <!-- Title Always Visible at Bottom -->
        <div class="title-bottom">
            <h3 class="title-text poppins-regular"><?php the_title(); ?></h3>
        </div>
